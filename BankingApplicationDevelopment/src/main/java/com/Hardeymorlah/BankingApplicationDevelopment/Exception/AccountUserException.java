package com.Hardeymorlah.BankingApplicationDevelopment.Exception;
...
public class AccountUserException {
...
return errorMap;
    ...
    public String handleSql(SQLIntegrityConstraintViolationException exception){
        return exception.getMessage();
    }
    @ResponseStatus(HttpStatus.BAD_REQUEST)
